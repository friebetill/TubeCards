...
/// BLoC for the [ImportExcelComponent].
@injectable
class ImportExcelBloc with ComponentBuildContext, ComponentLifecycleListener {
  Stream<ImportExcelViewModel>? _viewModel;
  Stream<ImportExcelViewModel>? get viewModel => _viewModel;
  ...
  Stream<ImportExcelViewModel> createViewModel() {
    if (_viewModel != null) {
      return _viewModel!;
    }
  ...
  ImportExcelViewModel _createViewModel(
